...
const Recommendations: FC<RecommendationsProps> = ({
  ...
  return <>
      {/* Recommendations Section - Decreased width by 20% */}
      <Card className="border-t-4 border-sprinto-blue max-w-[calc(3xl*0.7776)] mx-auto mt-10">
      ...
      {/* How Sprinto can help section - Decreased width by 20% */}
      <Card className="mt-10 max-w-[calc(3xl*0.7776)] mx-auto">
